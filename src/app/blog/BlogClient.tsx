...
export default function BlogClient({ articles, error }: BlogClientProps) {
  ...
  return (
    <div className="min-h-screen pt-24 pb-20">
      {/* Error Banner (if Sanity fetch failed) */}
      {error && (
            ...
            {sortedArticles.map((article, index) => (
              ...
              >
                ...
                <div className="aspect-video bg-gradient-to-br from-primary-gold/20 via-tech-teal/20 to-accent-red/20 flex items-center justify-center relative">
                  ...
                  {/* Category Badge */}
                  <div className={clsx(
                    'absolute top-4 left-4 px-3 py-1 text-white text-xs font-bold rounded-full z-10',
